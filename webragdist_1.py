...
DEFAULT_CONTEXT_PROMPT_TEMPLATE_1 = """
 ...
 The assistant is talkative and provides lots of specific details in form of bullet points or short paras from the context. Make sure to list the sources of your answer if they are web links only.
    ...
    #                   st.session_state.messages.append({"role": "user", "content": prompt}) 
                        ...
                        for message in messages:
                            if message["role"] == "user":
                                    modified_message = {"role": "user", "content": f"{message['content']} I-venture ISB and provide sources of answer as well"}
                            else:
                        ...
                        enhanced_response = query_engine.chat(str(prompt))
